...
def write(master,name,oc,pin):
    ...
    frec.write("Date                           Deposit          Withdraw              Balance\n")
...
def crdt_write(master,amt,accnt,name):
    ...
    frec.close()
    messagebox.showinfo("Transaction Complete!","Amount Deposited Successfully!")
    master.destroy()
    return
...
def debit_write(master,amt,accnt,name):
    ...
    if(int(amt)>camt):
        ...
        frec.write(str(strftime("[%Y-%m-%d] [%H:%M:%S]  ",gmtime()))+"     "+"              "+str(amti)+"              "+str(cb)+"\n")
        frec.close()
        messagebox.showinfo("Transaction Complete!","Amount Withdrawn Successfully!")
        master.destroy()
        return
...
def Cr_Amt(accnt,name):
    ...
    creditwn.configure(bg="snow4")
    fr1=tk.Frame(creditwn,bg="blue")
    l_title=tk.Message(creditwn,text="CS2520 BANK MANAGEMENT SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
    l1=tk.Label(creditwn,relief="raised",font=("Times",16),text="Enter Amount to be deposited: ")
    e1=tk.Entry(creditwn,relief="raised")
    l1.pack(side="top")
    e1.pack(side="top")
    b=tk.Button(creditwn,text="Deposit",font=("Times",16),relief="raised",command=lambda:crdt_write(creditwn,e1.get(),accnt,name))
    b.pack(side="top")
...
def De_Amt(accnt,name):
    ...
    debitwn.configure(bg="snow4")
    fr1=tk.Frame(debitwn,bg="blue")
    l_title=tk.Message(debitwn,text="CS2520 BANK MANAGEMENT SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
    l1=tk.Label(debitwn,relief="raised",font=("Times",16),text="Enter Amount to be withdrawn: ")
    e1=tk.Entry(debitwn,relief="raised")
    l1.pack(side="top")
    e1.pack(side="top")
    b=tk.Button(debitwn,text="Withdraw",font=("Times",16),relief="raised",command=lambda:debit_write(debitwn,e1.get(),accnt,name))
    b.pack(side="top")
...
def disp_tr_hist(accnt):
    ...
    disp_wn.configure(bg="snow4")
    fr1=tk.Frame(disp_wn,bg="blue")
    l_title=tk.Message(disp_wn,text="CS2520 BANK MANAGEMENT SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
    fr1=tk.Frame(disp_wn)
    fr1.pack(side="top")
    l1=tk.Message(disp_wn,text="Your Transaction History:",font=("Times",16),padx=100,pady=20,width=1000,bg="gray16",fg="snow4",relief="raised")
    l1.pack(side="top")
...
def logged_in_menu(accnt,name):
    ...
    rootwn.configure(background='snow4')
    fr1=tk.Frame(rootwn)
    fr1.pack(side="top")
    l_title=tk.Message(rootwn,text="CS2520 BANK MANAGEMENT SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
    label=tk.Label(text="Welcome, "+name,relief="raised",bg="snow4",font=("Times",16),fg="white",anchor="center",justify="center")
    label.pack(side="top")
...
def log_in(master):
    ...
    loginwn.configure(bg="snow4")
    fr1=tk.Frame(loginwn,bg="blue")
    l_title=tk.Message(loginwn,text="CS2520 BANK MANAGEMENT SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
    ...
    b.pack(side="top")
    b1=tk.Button(text="HOME",font=("Times",16),relief="raised",bg="gray16",fg="white",command=lambda: home_return(loginwn))
    b1.pack(side="top")
...
def Create():
    ...
    crwn.configure(bg="snow4")
    fr1=tk.Frame(crwn,bg="blue")
    l_title=tk.Message(crwn,text="CS2520 BANK MANAGEMENT SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
...
def Main_Menu():
    rootwn=tk.Tk()
    rootwn.geometry("1600x500")
    rootwn.title("CS2520 Bank Management System - 	CopyAssignment")
    rootwn.configure(background='snow4')
    fr1=tk.Frame(rootwn)
    fr1.pack(side="top")
    l_title=tk.Message(text="CS2520 BANK MANAGEMENT SYSTEM ",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
