...
def Cr_Amt(accnt,name):
    ...
    l_title=tk.Message(creditwn,text="Bank of CS2520",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
...
def De_Amt(accnt,name):
    ...
    l_title=tk.Message(debitwn,text="Bank of CS2520",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
...
def disp_tr_hist(accnt):
    ...
    l_title=tk.Message(disp_wn,text="Bank of CS2520",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
    ...
    fr1=tk.Frame(rootwn)
    fr1.pack(side="top")
    l_title=tk.Message(rootwn,text="Bank of CS2520",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
    ...
    b3.place(relx=0.4, rely=0.55, anchor="center")
    b4.place(relx=0.6, rely=0.4, anchor="center")
...
def log_in(master):
    ...
    l_title=tk.Message(loginwn,text="Bank of CS2520",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
...
def Create():
    ...
    l_title=tk.Message(crwn,text="Bank of CS2520",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
    l_title.config(font=("Arial","50","bold"))
    l_title.pack(side="top")
...
def Main_Menu():
    rootwn=tk.Tk()
    rootwn.geometry("1600x500")
    rootwn.title("Bank of CS2520 - 	CopyAssignment")
    rootwn.configure(background='snow4')
    fr1=tk.Frame(rootwn)
    fr1.pack(side="top")
    l_title=tk.Message(text="Bank of CS2520 ",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="gray16",justify="center",anchor="center")
